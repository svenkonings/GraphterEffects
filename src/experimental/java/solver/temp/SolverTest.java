    ...
    private static void testData(Jatalog jatalog) {
        try {
            jatalog.fact("node", "a")
                    ...
                    .rule(expr("color", "N", "green"), expr("female", "N"))
                    .rule(expr("left", "N1", "N2", "10"), expr("female", "N1"), expr("male", "N2"))

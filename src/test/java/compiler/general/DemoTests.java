...
public final class DemoTests {
    ...
    public void demo4() throws Exception {
        ...
        prolog.addTheory(
                ...
                clause(struct("image", var("N"), struct(FileUtils.fromResources("demo/images/wolf.png"))), struct("attribute", term("label"), var("N"), term("wolf"))),
                ...
                clause(struct("image", var("N"), struct(FileUtils.fromResources("demo/images/sheep.png"))), struct("attribute", term("label"), var("N"), term("type:Goat"))),
                ...
                clause(struct("image", var("N"), struct(FileUtils.fromResources("demo/images/cabbage.png"))), struct("attribute", term("label"), var("N"), term("type:Cabbage"))),
                ...
                clause(struct("image", var("N"), struct(FileUtils.fromResources("demo/images/boat.png"))), struct("attribute", term("label"), var("N"), term("type:Boat"))),
                ...
                struct("background-image", struct(FileUtils.fromResources("demo/images/river.png")))
        );
        Solver solver = new Solver(prolog);
        List<VisElem> visElemList = solver.solve();
        Document svg = SvgDocumentGenerator.generate(visElemList);

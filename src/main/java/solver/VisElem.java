...
public class VisElem {
    ...
    /**
     * If the value is parsable by {@link utils.StringUtils#parseInt(String)} it will be treated as the value of an
     * {@link IntVar} variable and set the name-variable pair. Otherwise the value will be treated as a {@link String}
     * constant and set the name-value pair.
     *

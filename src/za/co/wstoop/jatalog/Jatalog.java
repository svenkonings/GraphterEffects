 ...
 * <h3>The Parser</h3>
 * <p>
 * {@link #executeAll(Reader, QueryOutput)} uses a {@link Reader} to read a series of Datalog statements from a file or a String
 * and executes them.
 * </p><p>
...
public class Jatalog {
    ...
    /**
     * Executes all the statements in a file/string or another object wrapped by a {@link Reader}.
     * <p>

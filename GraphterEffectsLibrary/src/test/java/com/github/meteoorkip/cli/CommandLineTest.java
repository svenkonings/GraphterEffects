...
public class CommandLineTest {
    ...
    public void testNumberOfArguments() throws Exception {
        assertEquals("Error: Expected 3 arguments, received 0. Type --help for help.", getString(new String[]{}));
        assertEquals("Error: Expected 3 arguments, received 1. Type --help for help.", getString(new String[]{"a"}));
        assertEquals("Error: Expected 3 arguments, received 4. Type --help for help.", getString(new String[]{graphLoc, visLoc, svgLoc, "Hi!"}));
        assertEquals("Error: Expected 2 arguments, received 3. Type --help for help.", getString(new String[]{graphLoc, visLoc, svgLoc, "-n"}));
        assertEquals("", getString(new String[]{graphLoc, visLoc, svgLoc}));
        assertEquals("Error: If help flag is used, no arguments are expected. Type --help for help.", getString(new String[]{graphLoc, visLoc, svgLoc, "--help"}));
    }

    @Test
    public void testHelp() throws Exception {
        assertEquals(GraphterEffects.HELPSTRING, getString(new String[]{"--help"}));
        assertEquals(GraphterEffects.HELPSTRING, getString(new String[]{"-h"}));
    }

    @Test
    public void testVersion() throws Exception {
        assertEquals(GraphterEffects.VERSIONSTRING, getString(new String[]{"--version"}));
        assertEquals(GraphterEffects.VERSIONSTRING, getString(new String[]{"-v"}));
    }
    ...
    public void testIncompatibleFlags() throws Exception {
        assertEquals("Error: If help flag is used, no other flags may be used. Type --help for help.", getString(new String[]{"-vh"}));
    }

    @Test
    public void testNoGraph() throws Exception {
        assertEquals("", getString(new String[]{"-n", visLoc, svgLoc}));
        assertEquals("", getString(new String[]{visLoc, svgLoc, "-n"}));
        assertEquals("", getString(new String[]{visLoc, svgLoc, "--nograph"}));
    }
